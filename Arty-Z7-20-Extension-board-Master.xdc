...
#create_clock -period 3.000 [get_pins sys_clk_pin]  # thay đổi từ 4ns xuống 3ns
...
# Set output delay for mux_select

# Set output delay for opcode signals

# Set output delay for pc_enable

# Set output delay for program_counter_out signals
